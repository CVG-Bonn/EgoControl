...
from cosmos_predict2.configs.pose_conditioned.model import register_model_pose_conditioned
...
def make_config() -> Config:
    ...
    # TODO: for debugging log every iteration
    ...
    # pose conditional post-training config
    register_model_pose_conditioned()
    ...
    import_all_modules_from_package("cosmos_predict2.configs.pose_conditioned.experiment", reload=True)
    return c
