...
CosmosPredict2PoseConditionedModelSize = Literal["2B"]
CosmosPredict2PoseConditionedResolution = Literal["480"]
CosmosPredict2PoseConditionedFPS = Literal[16]


def get_cosmos_predict2_pose_conditioned_checkpoint(
    *,
    model_size: CosmosPredict2PoseConditionedModelSize,
    resolution: CosmosPredict2PoseConditionedResolution,
    fps: CosmosPredict2PoseConditionedFPS,
) -> str:
    return get_cosmos_predict2_video2world_checkpoint(
        model_size=model_size,
        model_type="Sample-Pose-Conditioned",
        resolution=resolution,
        fps=fps,
    )
